...
<head>
    ...
    <title>Masuk - Aplikasi Inventaris</title>
...
<body class="d-flex align-items-center py-4 bg-body-tertiary min-vh-100">
    <main class="form-signin w-100 m-auto" style="max-width: 400px;">
        <form method="POST" action="index.php?page=login" class="card p-4 shadow-lg border-secondary">
            ...
            <?php if(isset($_GET['msg'])): ?>
                <div class='alert alert-success'><?= escape_output($_GET['msg']) ?></div>
            <?php endif; ?>
            ...
            <button class="btn btn-primary w-100 btn-transisi" type="submit">Masuk</button>
            <div class="text-center mt-3">
                <span class="text-light">Belum punya akun? </span>
                <a href="index.php?page=register" class="text-decoration-none text-success fw-bold">Daftar di sini</a>
            </div>
        </form>
    </main>
</body>
